...
class E4Folder:
    ...
    def get_final_df(self):
        ...
        final_df.iloc[:, :9] = final_df.iloc[:, :9].ffill()
        ...
        final_df.iloc[:wake_index, 9] = final_df.iloc[:wake_index, 9].ffill()
...
def main():
    ...
    folder_dir = '/media/nvme1/sleep/CHIL_Submission/E4_data/'
    sleep_dir = "/media/nvme1/sleep/CHIL_Submission/sleep_stage/"
    report_dir = "/media/nvme1/sleep/CHIL_Submission/DREAMT_APNEA/"
    info = pd.read_csv("/media/nvme1/sleep/CHIL_Submission/participant_info.csv")

    aggre_path = "/media/nvme1/sleep/CHIL_Submission/E4_aggregate/"
