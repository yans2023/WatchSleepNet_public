...
out_dir = ".../MESA_PPG_raw/" # TO fill in: path to save the MESA extract raw PPG data, this folder needs to be created before running this file

def process_mesa(out_dir):
    mesa_dir = ".../mesa/polysomnography/edfs/" # TO fill in: path to the MESA dataset EDF raw data files
    ...
    for file in tqdm(files):
        ...
        label_path = f".../mesa/polysomnography/annotations-events-profusion/{file.split('.')[0]}-profusion.xml"
        try:
